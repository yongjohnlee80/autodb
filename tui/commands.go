...
func (h *Host) commands() map[string]decl.HandlerFunc {
	return map[string]decl.HandlerFunc{
		...
		"App.noteOpenClosed":     none(h.closeNoteOpen),
		...
		"App.historyClosed":           none(h.historyClosed),
		...
		"App.keyslotClosed":           none(h.keyslotClosed),
		"App.keyslotEnable":           none(h.keyslotEnable),
		"App.keyslotRemove":           none(h.keyslotRemoveAction),
		"App.keyslotConfirmed":        none(h.keyslotConfirmed),
		"App.keyslotConfirmCancelled": none(h.keyslotConfirmCancelled),
