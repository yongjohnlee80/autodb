...
| `ErrNotExecuted` | decl wire_query.go:186; wire_query.go:346, wire_extended.go:1182 | wire simple + ext | transport | The recorded OUTCOME of a statement PostgreSQL did not run because an earlier one failed — a history status, not a client refusal.  Justification: applicability:§7.1. |
