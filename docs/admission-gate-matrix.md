...
| `ErrSessionBusy` | decl session.go:56; session.go:839, session_timeout.go:343, session_tx.go:611 | session, wire | authority | One statement at a time per session; a second concurrent call refuses.  Justification: applicability:§7.5. |
