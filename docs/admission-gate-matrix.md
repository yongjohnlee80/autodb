...
| `ErrSessionCapExceeded` / `ErrLeaseCapExceeded` / `ErrResidentBudgetExceeded` | decl session.go:67, session.go:297 and session.go:300; raised session.go:333, session.go:337, session.go:341, session.go:352, session.go:361, wire_session.go:465, wire_session.go:467 and wire_session.go:469 | session/wire open | resource | Cap refusals at open; audited distinctly, uniform on the wire (front-door rows carry the identity).  Justification: applicability:§7.2； applicability:§7.2； applicability:§7.2. |
