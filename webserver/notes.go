...
// validation load-bearing for autodb's filesystem layout. A separator or a `..` here is the difference between a note directory and
// someone else's home.
//
...
// it. The rule now belongs to config, and is enforced at
...
// log; the browser learns only that it was refused.
